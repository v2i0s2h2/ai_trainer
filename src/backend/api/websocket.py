...
# Import trainers
# Trainers are now lazy-loaded in get_trainer()
...
class HamstringMedialBridgeTrainer:
    ...
    def __init__(self):
        ...
        print(
            "[HamstringMedialBridgeTrainer] Using basic processing (full trainer coming soon)"
        )
...
class BallSqueezeTrainer:
    ...
    def __init__(self):
        ...
        self.current_feedback = (
            "Ball Squeeze - Butterfly position with ball between knees"
        )
...
class DepressionRowTrainer:
    ...
    def __init__(self):
        self.reps = 0
        self.current_feedback = (
            "Depression Row - Shoulder forward, chest lifted, elbow at 45°"
        )
        print(
            "[DepressionRowTrainer] Using basic processing (full trainer coming soon)"
        )
...
class WorkoutStreamManager:
    ...
    def get_trainer(self):
        ...
        if (
            ...
            or exercise_lower == "wall-squat"
            or exercise_lower == "box-squat"
            ...
            return RowTrainer()
        elif "padcuff" in exercise_lower or (
            "pad" in exercise_lower and "cuff" in exercise_lower
        ):
        ...
        elif "kneedrop" in exercise_lower or (
            "knee" in exercise_lower and "drop" in exercise_lower
        ):
            # Knee Drop trainer
            try:
        ...
        elif "hamstring" in exercise_lower and (
            "medial" in exercise_lower or "bridge" in exercise_lower
        ):
        ...
        elif "ballsqueeze" in exercise_lower or (
            "ball" in exercise_lower and "squeeze" in exercise_lower
        ):
        ...
        elif "quadstretch" in exercise_lower or (
            "quad" in exercise_lower
            and ("stretch" in exercise_lower or "extension" in exercise_lower)
        ):
        ...
        elif "depressionrow" in exercise_lower or (
            "depression" in exercise_lower and "row" in exercise_lower
        ):
        ...
        elif "weightedpullup" in exercise_lower or (
            "weighted" in exercise_lower and "pull" in exercise_lower
        ):
            # Weighted Pull-ups - use PullupTrainer
            return PullupTrainer()
        elif "closegrippulldown" in exercise_lower or (
            "close" in exercise_lower
            and "grip" in exercise_lower
            and "pull" in exercise_lower
        ):
            # Close Grip Pull Down - use PullupTrainer
            return PullupTrainer()
        elif "widegriprow" in exercise_lower or (
            "wide" in exercise_lower
            and "grip" in exercise_lower
            and "row" in exercise_lower
        ):
            # Wide Grip Row - use RowTrainer
            return RowTrainer()
        elif "singlearmrow" in exercise_lower or (
            "single" in exercise_lower
            and "arm" in exercise_lower
            and "row" in exercise_lower
        ):
            # Single Arm Row - use RowTrainer
            return RowTrainer()
        elif "weighteddip" in exercise_lower or (
            "weighted" in exercise_lower and "dip" in exercise_lower
        ):
            # Weighted Dips - use TricepDipTrainer
            return TricepDipTrainer()
        elif "inclineskullcrusher" in exercise_lower or (
            "incline" in exercise_lower and "skull" in exercise_lower
        ):
            # Incline Skull Crushers - use TricepDipTrainer
            return TricepDipTrainer()
        elif "inclinebenchpress" in exercise_lower or (
            "incline" in exercise_lower
            and "bench" in exercise_lower
            and "press" in exercise_lower
        ):
            # Incline Bench Press - use PushupTrainer for now
            return PushupTrainer()
        elif "flatdumbbellbenchpress" in exercise_lower or (
            "flat" in exercise_lower
            and "dumbbell" in exercise_lower
            and "bench" in exercise_lower
        ):
            # Flat Dumbbell Bench Press - use PushupTrainer for now
            return PushupTrainer()
        elif "cablecrossover" in exercise_lower or (
            "cable" in exercise_lower
            and ("crossover" in exercise_lower or "fly" in exercise_lower)
        ):
            # Cable Crossovers/Flys - use PushupTrainer for now
            return PushupTrainer()
        elif "hammercurl" in exercise_lower or (
            "hammer" in exercise_lower and "curl" in exercise_lower
        ):
            # Hammer Curls - use BicepCurlTrainer
            return BicepCurlTrainer()
        elif "barbellcurl" in exercise_lower or (
            "barbell" in exercise_lower and "curl" in exercise_lower
        ):
            # Barbell Curls - use BicepCurlTrainer
            return BicepCurlTrainer()
        elif "cablecrunch" in exercise_lower or (
            "cable" in exercise_lower and "crunch" in exercise_lower
        ):
            # Cable Crunch - use CrunchTrainer
            return CrunchTrainer()
        elif "inclinedumbbellshoulderpress" in exercise_lower or (
            "incline" in exercise_lower
            and "dumbbell" in exercise_lower
            and "shoulder" in exercise_lower
        ):
            # Incline Dumbbell Shoulder Press - use ShoulderPressTrainer
            return ShoulderPressTrainer()
        elif "lateralraisesadvanced" in exercise_lower or (
            "lateral" in exercise_lower
            and "raises" in exercise_lower
            and "advanced" in exercise_lower
        ):
            # Lateral Raises Advanced - use LateralRaiseTrainer
            return LateralRaiseTrainer()
        elif "lateralraisesweakspot" in exercise_lower or (
            "lateral" in exercise_lower and "weak" in exercise_lower
        ):
            # Lateral Raises Weak Spot - use LateralRaiseTrainer
            return LateralRaiseTrainer()
        elif "dipsparallelbars" in exercise_lower or (
            "dips" in exercise_lower and "parallel" in exercise_lower
        ):
            # Dips Parallel Bars - use TricepDipTrainer
            return TricepDipTrainer()
        elif "trapsshrug" in exercise_lower or (
            "trap" in exercise_lower and "shrug" in exercise_lower
        ):
            # Traps/Shrugs - use basic trainer for now
            return BicepCurlTrainer()
        elif "forearmextensionfix" in exercise_lower or (
            "forearm" in exercise_lower and "extension" in exercise_lower
        ):
            # Forearm Extension Fix - use basic trainer
            return BicepCurlTrainer()
        elif "forearmflexionfix" in exercise_lower or (
            "forearm" in exercise_lower and "flexion" in exercise_lower
        ):
            ...
            raise ValueError(
                f"Unknown exercise: {self.exercise}. Available: {available}"
            )
