    ...
    onMount(async () => {
        try {
            ...
            const res = await fetch(
                `${API_BASE_URL}/api/exercises/${exercise}`,
            );
            if (res.ok) {
...
<div class="workout-page">
    {#if error}
        <div class="error-banner">
            ...
            <button
                class="retry-btn"
                on:click={() => workoutStore.connect(exercise)}
            >
                Retry
            </button>
        </div>
                ...
                <div class="info-section">
                    ...
                    {#if exerciseData.target_muscles && exerciseData.target_muscles.length > 0}
                        <div class="target-muscles">
                            ...
                            <span class="muscles"
                                >{exerciseData.target_muscles.join(", ")}</span
                            >
                        </div>
                    {/if}
                </div>
            ...
            <div class="camera-setup-card">
                <div class="setup-header">
                    ...
                    <p class="setup-subtitle">
                        Position your camera correctly for best results
                    </p>
                </div>
                ...
                <div class="setup-content">
                    ...
                    {#if exerciseData.description}
                        <div class="exercise-description-section">
                            ...
                            <p class="exercise-description-text">
                        ...
                        <div class="diagram-container">
                            ...
                            <div class="angle-indicator">
                                ...
                                {:else if exerciseData.camera_position.angle.includes("45")}
                                    <div
                                        class="camera-icon-large angle-45-camera"
                                    >
                                        📹
                                    </div>
                            ...
                            <div class="distance-label">
                                {exerciseData.camera_position.distance}
                            </div>
                            <div class="height-label">
                                {exerciseData.camera_position.height}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="setup-instructions">
                        ...
                        <div class="instruction-item">
                            ...
                            <div class="instruction-content">
                                <strong>Angle:</strong>
                                {exerciseData.camera_position.angle}
                            </div>
                        </div>
                        <div class="instruction-item">
                    ...
                    {#if exerciseData.equipment && exerciseData.equipment.length > 0}
                        <div class="equipment-section">
                            ...
                            <div class="equipment-list">
                                {#each exerciseData.equipment as item}
                                    <div
                                        ...
                                        class:optional={!item.required}
                                    >
                                        <div class="equipment-content">
                                            {#if item.image}
                                                <div
                                                    class="equipment-image-wrapper"
                                                >
                                                    <img
                                                        src={item.image}
                                                        alt={item.name}
                            ...
                            <div class="equipment-note">
                                💡 <strong>Need equipment?</strong> Check out the
                                Equipment Library for recommended suppliers.
                            </div>
                        </div>
                    {/if}
                </div>
    ...
    <div class="video-section">
        <div class="video-wrapper">
            <LiveVideoFeed
                cameraMode={selectedCamera === "client" ? "client" : "auto"}
            />
            <RepCounter />
        </div>
    </div>
